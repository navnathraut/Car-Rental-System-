...
public:
  ...
  void addNewCar()
  {
    ...
    strg<< power;
    string s1 = strg.str();
    strg<< batteryCapacity;
    string s2 = strg.str();
    strg<< range;
    string s3 = strg.str();
    strg<< chargingTime;
    string s4 = strg.str();
    strg<< seatingCapacity;
    string s5 = strg.str();
    strg<< ratePerKm;
    string s6 = strg.str();
    strg<< stocks;
...
void takeBackCar()
{
  ...
  for (customerSrNo = 0; customerSrNo < Customer::totalCustomers(); customerSrNo++)
  {
    ...
    {
        ostringstream strg1;
        strg1<< customer[customerSrNo].rentDate;
        string s1 = strg1.str();
        ostringstream strg2;
        strg2<< customer[customerSrNo].rentDays;
        string s2 = strg2.str();
